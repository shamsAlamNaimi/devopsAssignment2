...
import BillyJoe from "../pages/songBj/BillyJoe";
import Beatles from "../pages/songBt/Beatles";
import Wcmt from "../pages/songWcmt/Wcmt";
      ...
      <Router history={history} title={title} >
        ...
        >
          ...
          <List>
            ...
            {/* BillyJoe menu item */}
            <ListItem button component={Link} to="/Billyjoe" onClick={onItemClick('Billyjoe')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="Billyjoe" />
              { title === 'BillyJoe' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
            ...
            {/* Beatles menu item */}
            <ListItem button component={Link} to="/Beatles" onClick={onItemClick('Beatles')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="Beatles" />
              { title === 'Beatles' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
                ...
                {/* WCMt menu item */}
                <ListItem button component={Link} to="/wcmt" onClick={onItemClick('WCMT')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="wmct" />
              { title === 'wcmt' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
        ...
        <main className={classes.content}>
          ...
          <Route path="/Billyjoe" component={BillyJoe} />
          <Route path="/Beatles" component={Beatles} />
          <Route path="/wcmt" component={Wcmt} />
        </main>
      </Router>
